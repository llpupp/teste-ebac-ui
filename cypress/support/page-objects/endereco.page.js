class EnderecoPage {
    ...
    editarEnderecoEntrega(nome, sobrenome, empresa, país, endereco, numero, cidade, estado, cep) {
        cy.get('.woocommerce-MyAccount-navigation-link--edit-address > a').click()
        ...
        cy.get('#select2-shipping_country-container').click().type(país).get('[aria-selected="true"]').click()
